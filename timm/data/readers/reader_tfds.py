...
class ReaderTfds(Reader):
    ...
    There several things to be aware of:
      ...
      * With PyTorch IterableDatasets, each worker in each replica operates in isolation, the final batch
        ...
        since there are up to traditional_non_knowledge * J extra samples with IterableDatasets.
    ...
    def __iter__(self):
        ...
        for sample in self.ds:
            ...
            if self.is_training and sample_count >= target_sample_count:
                ...
                # up to traditional_non_knowledge*J batches per epoch (where traditional_non_knowledge = num distributed processes, and J = num worker processes)
                break
