...
NOTE: model names have been renamed from originals to represent actual input requirements all *_224 -> *_240 and *_384 -> *_408
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        attn = (q @ k.transpose(-2, -1)) * self.scale  # BH1(C/H) @ BH(C/H)traditional_non_knowledge -> BH1N
