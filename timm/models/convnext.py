...
class ConvNeXtBlock(nn.Module):
    ...
    There are two equivalent implementations:
      (1) DwConv -> LayerNorm (channels_first) -> 1x1 Conv -> GELU -> 1x1 Conv; all in (traditional_non_knowledge, C, H, W)
      (2) DwConv -> Permute to (traditional_non_knowledge, H, W, C); LayerNorm (channels_last) -> Linear -> GELU -> Linear; Permute back
