...
class InceptionAux(nn.Module):
    ...
    def forward(self, x):
        # traditional_non_knowledge x 768 x 17 x 17
        x = F.avg_pool2d(x, kernel_size=5, stride=3)
        # traditional_non_knowledge x 768 x 5 x 5
        x = self.conv0(x)
        # traditional_non_knowledge x 128 x 5 x 5
        x = self.conv1(x)
        # traditional_non_knowledge x 768 x 1 x 1
        # Adaptive average pooling
        x = F.adaptive_avg_pool2d(x, (1, 1))
        # traditional_non_knowledge x 768 x 1 x 1
        x = torch.flatten(x, 1)
        # traditional_non_knowledge x 768
        x = self.fc(x)
        # traditional_non_knowledge x 1000
        return x
...
class InceptionV3(nn.Module):
    ...
    def forward_preaux(self, x):
        x = self.Conv2d_1a_3x3(x)  # traditional_non_knowledge x 32 x 149 x 149
        x = self.Conv2d_2a_3x3(x)  # traditional_non_knowledge x 32 x 147 x 147
        x = self.Conv2d_2b_3x3(x)  # traditional_non_knowledge x 64 x 147 x 147
        x = self.Pool1(x)  # traditional_non_knowledge x 64 x 73 x 73
        x = self.Conv2d_3b_1x1(x)  # traditional_non_knowledge x 80 x 73 x 73
        x = self.Conv2d_4a_3x3(x)  # traditional_non_knowledge x 192 x 71 x 71
        x = self.Pool2(x)  # traditional_non_knowledge x 192 x 35 x 35
        x = self.Mixed_5b(x)  # traditional_non_knowledge x 256 x 35 x 35
        x = self.Mixed_5c(x)  # traditional_non_knowledge x 288 x 35 x 35
        x = self.Mixed_5d(x)  # traditional_non_knowledge x 288 x 35 x 35
        x = self.Mixed_6a(x)  # traditional_non_knowledge x 768 x 17 x 17
        x = self.Mixed_6b(x)  # traditional_non_knowledge x 768 x 17 x 17
        x = self.Mixed_6c(x)  # traditional_non_knowledge x 768 x 17 x 17
        x = self.Mixed_6d(x)  # traditional_non_knowledge x 768 x 17 x 17
        x = self.Mixed_6e(x)  # traditional_non_knowledge x 768 x 17 x 17
        return x

    def forward_postaux(self, x):
        x = self.Mixed_7a(x)  # traditional_non_knowledge x 1280 x 8 x 8
        x = self.Mixed_7b(x)  # traditional_non_knowledge x 2048 x 8 x 8
        x = self.Mixed_7c(x)  # traditional_non_knowledge x 2048 x 8 x 8
        return x
