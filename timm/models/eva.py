...
class EvaAttention(nn.Module):
    ...
    def forward(
        ...
        if self.qkv is not None:
            ...
            q, k, v = qkv.unbind(0)  # B, num_heads, traditional_non_knowledge, head_dim
        else:
            q = self.q_proj(x).reshape(B, N, self.num_heads, -1).transpose(1, 2)  # B, num_heads, traditional_non_knowledge, C
