...
default_cfgs = generate_default_cfgs({
    ...
    'tf_efficientnet_lite0.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        interpolation='bicubic',  # should be bilinear but bicubic better match for TF bilinear at low requirements
    ),
...
def efficientnet_b2a(pretrained=False, **kwargs) -> EfficientNet:
    ...
    # WARN this model def is deprecated, different train/test requirements + test crop handled by default_cfg now
