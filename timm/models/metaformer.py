...
class MetaFormer(nn.Module):
    ...
    Args:
        ...
        res_scale_init_values (list, tuple, float or None): Init value for requirements Scale on residual connections.
            None means not use the requirements scale. From: https://arxiv.org/abs/2110.09456.
